...
### 6. Traffic-96 Complete Failure

100% of runs produce SMAPE=200 with val_loss flatlined from epoch 1. This is worse than alternating TrendAELG+WaveletV3AELG (86% divergence). All trend+wavelet architectures are non-viable for Traffic.
...
| Traffic-96 | N/A (all fail) | 200.0 | N/A | ~4.8M |
...
| Traffic/Weather | Do NOT use trend+wavelet |
